...
class User(AbstractUser):
    ...
    batch_name = models.CharField(max_length=100, blank=True, default='Django Batch 1')
    avatar_url = models.URLField(blank=True, default='')

    @property
    def is_instructor(self):
        return self.role == 'STAFF' or self.is_staff or self.is_superuser or self.is_admin_role
